...
public class VoiceModel {
    ...
    public static final String ZhEnMale2 = "zh_en_male_2";
    ...
    static List<String> getList() {
        String[] valueList = new String[] { ZhEnFemale1, ZhEnFemale2, ZhEnMale1, ZhEnMale2, TaiFemale1, TaiFemale2, TaiMale1 };
